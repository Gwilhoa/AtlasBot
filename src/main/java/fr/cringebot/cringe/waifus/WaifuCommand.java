...
public class WaifuCommand {
	...
	private static void tradewaifu(Message msg) {
		...
		if (eb != null) {
			...
			bttn.add(new ButtonImpl("trade_ok;"+Integer.parseInt(msg.getContentRaw().split(" ")[2]) +";"+Integer.parseInt(msg.getContentRaw().split(" ")[3]), "accepter", ButtonStyle.SUCCESS, false, null));
